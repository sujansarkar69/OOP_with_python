...
youngest_player = Sakib

if Mushfiq < youngest_player:
    youngest_player = Mushfiq
if Mustafiz < youngest_player:
    youngest_player = Mustafiz
if Riyad < youngest_player:
    youngest_player = Riyad
